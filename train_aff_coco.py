...
if __name__ == '__main__':
    ...
    train_dataset = coco.data.COCOAffDataset(args.train_list, label_la_dir=args.la_crf_dir, label_ha_dir=args.ha_crf_dir,
                                               coco_root=args.coco_root, cropsize=args.crop_size, radius=5,
